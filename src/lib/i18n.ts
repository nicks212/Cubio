...
export const DEFAULT_TRANSLATIONS: T = {
  ...
  'apartments.search_placeholder': 'ბინააპარტამენტის ძებნა...',
  'apartments.price_min': 'მინ. ფასი',
  'apartments.price_max': 'მაქს. ფასი',
  ...
  'products.keywords': 'საძიებო სიტყვები',
  'products.keywords_placeholder': 'მაგ: საკმეველი, სურნელოვანი, meditation',
  'products.zodiac': 'Zodiac თავსებადობა',
  'zodiac.aries': 'ვერძი',
  'zodiac.taurus': 'კუროსი',
  'zodiac.gemini': 'ტყუპები',
  'zodiac.cancer': 'კირჩხიბი',
  'zodiac.leo': 'ლომი',
  'zodiac.virgo': 'ქალწული',
  'zodiac.libra': 'სასწორი',
  'zodiac.scorpio': 'მორიელი',
  'zodiac.sagittarius': 'მშვილდოსანი',
  'zodiac.capricorn': 'თხის რქა',
  'zodiac.aquarius': 'მერწყული',
  'zodiac.pisces': 'თევზები',
  'products.description': 'აღწერა',
  'products.in_stock': 'მარაგშია',
  'products.out_of_stock': 'ამოწურულია',
  'products.search_placeholder': 'პროდუქტის ძებნა...',
  'products.filter_all_categories': 'ყველა კატეგორია',
  'products.filter_uncategorized': 'კატეგორიის გარეშე',
  'products.filter_all_stock': 'ყველა სტატუსი',
  'products.price_min': 'მინ. ფასი',
  'products.price_max': 'მაქს. ფასი',
  'products.no_results': 'ფილტრის პირობებს შეესაბამება 0 პროდუქტი',
...
export const DEFAULT_TRANSLATIONS_EN: T = {
  ...
  'apartments.search_placeholder': 'Search apartments...',
  'apartments.price_min': 'Min price',
  'apartments.price_max': 'Max price',
  ...
  'products.keywords': 'Search Keywords',
  'products.keywords_placeholder': 'e.g. incense, aromatic, meditation, საკმეველი',
  ...
  'products.filter_all_categories': 'All Categories',
  'products.filter_uncategorized': 'Uncategorized',
  'products.filter_all_stock': 'All Stock',
  'products.price_min': 'Min price',
  'products.price_max': 'Max price',
  'products.no_results': 'No products match your filters',
